...
import com.jm.jengo.dealz.fragments.SearchResultFragment.OnListFragmentInteractionListener;
...
public class SearchResultRecyclerViewAdapter extends RecyclerView.Adapter<SearchResultRecyclerViewAdapter.ViewHolder> {
    ...
    public SearchResultRecyclerViewAdapter(List<Object> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
